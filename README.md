...
A gallery of **117 spring-physics micro-interactions** for web interfaces. Each effect ships with a live demo, a physics-style parameter readout, and copy-paste **CSS** + **React** code.
...
src/
  ...
  content/body.html      # all markup (header, 117 cards, physics, footer),
